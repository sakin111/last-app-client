        ...
        <section className="min-h-screen py-16 px-4">
            <div className="mx-auto max-w-3xl">
                ...
                <div className="prose prose-lg max-w-none text-gray-700 space-y-8">
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-gray-900 mb-3">Creating Your Profile</h2>
                        <p>
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-gray-900 mb-3">Finding Travel Buddies</h2>
                        <p>
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-gray-900 mb-3">Planning Your Trip</h2>
                        <p>
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-gray-900 mb-3">Managing Your Account</h2>
                        <p>
