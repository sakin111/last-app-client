        ...
        <section className="min-h-screen py-16 px-4 bg-background">
            <div className="mx-auto max-w-3xl">
                ...
                <div className="prose prose-lg max-w-none text-muted-foreground space-y-8">
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-foreground mb-3">3. User Conduct</h2>
                        <p>
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-foreground mb-3">4. Content Ownership</h2>
                        <p>
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-foreground mb-3">5. Subscriptions and Payments</h2>
                        <p>
                ...
                <div className="mt-12 pt-8 border-t border-border text-center">
                    <p className="text-muted-foreground">
                        ...
                        <a href="mailto:legal@typers.com" className="text-primary hover:underline">
                            legal@typers.com
                        </a>
                    </p>
                </div>
