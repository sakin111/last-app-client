        ...
        <section className="min-h-screen py-16 px-4">
            <div className="mx-auto max-w-3xl">
                ...
                <div className="prose prose-lg max-w-none text-gray-700 space-y-8">
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-gray-900 mb-3">What Drives Us</h2>
                        <p>
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-gray-900 mb-3">Our Community</h2>
                        <p>
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-gray-900 mb-3">Looking Ahead</h2>
                        <p>
                ...
                <div className="mt-12 pt-8 border-t border-gray-200 text-center">
                    <p className="text-gray-600">
                        ...
                        <a href="mailto:careers@typers.com" className="text-blue-600 hover:underline">
                            careers@typers.com
                        </a>
                    </p>
                </div>
