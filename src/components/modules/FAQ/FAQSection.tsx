        ...
        <section className="min-h-screen py-16 px-4">
            <div className="mx-auto max-w-3xl">
                ...
                <div className="prose prose-lg max-w-none text-gray-700 space-y-8">
                    <div>
                        <h2 className="text-2xl font-semibold text-gray-900 mb-3">What is Typers?</h2>
                        <p>
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-gray-900 mb-3">Is Typers free to use?</h2>
                        <p>
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-gray-900 mb-3">How do I find a travel buddy?</h2>
                        <p>
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-gray-900 mb-3">Is it safe to travel with strangers?</h2>
                        <p>
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-gray-900 mb-3">How do I cancel my subscription?</h2>
                        <p>
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-gray-900 mb-3">Can I use Typers for group travel?</h2>
                        <p>
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-gray-900 mb-3">What if I have issues with another user?</h2>
                        <p>
