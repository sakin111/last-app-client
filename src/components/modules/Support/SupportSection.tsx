        ...
        <section className="min-h-screen py-16 px-4">
            <div className="mx-auto max-w-3xl">
                ...
                <div className="prose prose-lg max-w-none text-gray-700 space-y-8">
                    <div>
                        <h2 className="text-2xl font-semibold text-gray-900 mb-3">Find Your Travel Buddy</h2>
                        <p>
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-gray-900 mb-3">Community-Driven Recommendations</h2>
                        <p>
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-gray-900 mb-3">Safe & Verified Profiles</h2>
                        <p>
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-gray-900 mb-3">Trip Planning Made Easy</h2>
                        <p>
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-gray-900 mb-3">24/7 Support</h2>
                        <p>
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-gray-900 mb-3">Flexible Subscription Plans</h2>
                        <p>
