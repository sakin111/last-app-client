    ...
    <section className="py-24 bg-gradient-to-br from-primary via-primary/90 to-primary/80 text-primary-foreground relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-xl md:text-2xl mb-10 text-primary-foreground/80 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/register">
              <Button
                size="lg"
                variant="outline"
                className='text-xl bg-background text-foreground hover:bg-muted border-border'
              >
