        ...
        <section className="min-h-screen py-16 px-4 bg-background">
            <div className="mx-auto max-w-3xl">
                ...
                <div className="prose prose-lg max-w-none text-muted-foreground space-y-8">
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-foreground mb-3">General Inquiries</h2>
                        <p>
                            For general questions about Typers, our services, or how to get started, please email us at{" "}
                            <a href="mailto:hello@typers.com" className="text-primary hover:underline">
                                hello@typers.com
                            </a>
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-foreground mb-3">Customer Support</h2>
                        <p>
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-foreground mb-3">Business & Partnerships</h2>
                        <p>
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-foreground mb-3">Press & Media</h2>
                        <p>
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-foreground mb-3">Office Location</h2>
                        <p>
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-foreground mb-3">Social Media</h2>
                        <p>
